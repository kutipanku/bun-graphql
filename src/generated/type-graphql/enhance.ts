...
const modelsInfo = {
  User: ["id", "email", "name"],
  Post: ["id", "title", "content", "published", "userId"],
};
...
const outputsInfo = {
  ...
  PostCountAggregate: ["id", "title", "content", "published", "userId", "_all"],
  PostAvgAggregate: ["id", "userId"],
  PostSumAggregate: ["id", "userId"],
  PostMinAggregate: ["id", "title", "content", "published", "userId"],
  PostMaxAggregate: ["id", "title", "content", "published", "userId"],
};
...
const inputsInfo = {
  ...
  PostCreateInput: ["title", "content", "published", "user"],
  PostUpdateInput: ["title", "content", "published", "user"],
  PostCreateManyInput: ["id", "title", "content", "published", "userId"],
  ...
  PostCreateWithoutUserInput: ["title", "content", "published"],
  ...
  PostCreateManyUserInput: ["id", "title", "content", "published"],
  PostUpdateWithoutUserInput: ["title", "content", "published"],
};
